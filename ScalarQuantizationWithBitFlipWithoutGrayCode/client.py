...
def qunatization(params):
    ...
    for row in indices_array:
        ...
        for element in row:
            ...
            binary_representation = format(element.item(), '06b')
            flipped_binary_code = ''.join([flip_bit(bit) for bit in binary_representation])
            ...
            integer_value = int(flipped_binary_code, 2)
